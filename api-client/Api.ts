...
> extends HttpClient<SecurityDataType> {
  ...
  auth = {
     ...
     */
    authControllerRegister: (data: UserCreateDto, params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/auth/register`,
        method: "POST",
        body: data,
  ...
  anime = {
     ...
     * @name AnimeControllerGetReleases
     * @summary Получить релизы аниме
     * @request GET:/anime/catalog/releases
     */
    animeControllerGetReleases: (
      query?: {
        /** @default 1 */
        page?: number;
        /** @default 10 */
        limit?: number;
        /** ID жанров (через запятую) */
        genres?: number[];
      },
      params: RequestParams = {},
    ) =>
